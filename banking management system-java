	...
	void showMenu() {
		...
		do {
			...
			case 'B':
				...
				System.out.println();
				break;
			//Case 'C' allows the user to withdraw money from their account using the 'withdraw' method
			case 'C':
				...
				System.out.println();
				break;
			//Case 'D' allows the user to view their most recent transaction using the 'getPreviousTransaction' method
			case 'D':
				System.out.println("====================================");
